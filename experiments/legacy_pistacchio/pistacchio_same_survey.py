...
# # --------------------------------------------------
# if len(sys.argv) < 5:
#     print("Usage: python3 pistacchio_same_survey.py <model_name> <alice_ideology> <jack_ideology> <run_num>")
#     sys.exit(1)
#
...
#     os.makedirs("./same_survey", exist_ok=True)
#     safe_model = model_name.replace(".", "").replace(":", "")
#     timestamp = datetime.datetime.now().strftime("%Y%m%d_%H%M%S")
#     filename = (
#         f"./same_survey/affective_{safe_model}_alice-{alice_ideology}_jack-{jack_ideology}_"
...
# os.makedirs("./same_survey", exist_ok=True)
# log_filename = (
#     f"./same_survey/{safe_model_name}_alice-{alice_ideology}_jack-{jack_ideology}_run-{run_num}_"
